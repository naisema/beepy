...
static const unsigned char FONT[59][GLYPH_H] = {
    ...
    /* Slot 31 was empty until the QUIT page (DESIGN.md 1.6) needed to ask a
     * question. Nothing else in the program renders a '?', so filling a hole
     * in the table moves no glyph and no golden -- it only stops one page
     * printing a space where its question mark should be. */
    [31] = {0x0E,0x11,0x01,0x06,0x04,0x00,0x04},           /* ? */
